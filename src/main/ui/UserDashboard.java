...
public class UserDashboard extends JFrame {
    ...
    public UserDashboard(User user) {
        ...
        addSidebarButton("📦 Prodotti", e -> {
            JPanel panel = new ProdottiPanel(false); // TODO: vietare modifiche al main.db se role == utente
            setContent(panel);
        });
        addSidebarButton("🧾 Ordini", e -> {
            JPanel panel = new OrdiniPanel(user.getId()); // TODO: vietare modifiche al main.db se role == utente
            setContent(panel);
        });
